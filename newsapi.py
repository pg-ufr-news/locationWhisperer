...
keywordsFields = ["keyword","language","topic","topicColor","keywordColor","limitPages","ratioNew",
                  "continent","gnd","geonames","latitude","longitude","geotype","country","ipcc"]
...
'''
##TODO decomment
keywordsDF = addNewNames('https://raw.githubusercontent.com/pg-ufr-news/gensChuchoter/main/csv/sentiments_new_locations.csv', keywordsDF, 0.5, 'en', 9)
keywordsDF = addNewNames('https://raw.githubusercontent.com/pg-ufr-news/winterIsComing/main/csv/sentiments_new_locations.csv', keywordsDF, 0.5, 'en', 9)
keywordsDF = addNewNames('https://raw.githubusercontent.com/pg-ufr-news/personWhisperer/main/csv/sentiments_new_locations.csv', keywordsDF, 0.6, 'en', 9)
'''
